package com.kernel.finch.core.list
...
internal class CellAdapter : RecyclerView.Adapter<ViewHolder<out Cell<*>>>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder<*> =
        delegates.values.toList()[viewType].createViewHolder(parent)

    override fun onBindViewHolder(holder: ViewHolder<out Cell<*>>, position: Int) =
        holder.forceBind(items[position])
    ...
    private class DiffCallback(
        private val oldItems: List<Cell<*>>,
        private val newItems: List<Cell<*>>
    ) : DiffUtil.Callback() {

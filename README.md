...
dependencies {
    ...
    debugImplementation 'com.github.kernel0x.finch:log:2.3.9'
    releaseImplementation 'com.github.kernel0x.finch:log-noop:2.3.9'
    // optional only for OkHttp
    debugImplementation 'com.github.kernel0x.finch:log-okhttp:2.3.9'
    releaseImplementation 'com.github.kernel0x.finch:log-okhttp-noop:2.3.9'
    // optional only for GRPC
    debugImplementation 'com.github.kernel0x.finch:log-grpc:2.3.9'
